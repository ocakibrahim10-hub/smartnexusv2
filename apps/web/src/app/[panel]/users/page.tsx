...
import { normalizePhone, PHONE_REQUIRED_ROLES, formatPhoneDisplay } from '@/lib/phone';
...
export default function UsersPage() {
  ...
  const save = async () => {
    ...
    if (PHONE_REQUIRED_ROLES.has(form.role) && !normalizePhone(form.phone)) {
      alert('Bu rol için geçerli cep telefonu zorunludur (5XX XXX XX XX)');
      return;
    }
    setSaving(true);
    try {
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Personel ekleyin; telefon ve şifre ile /isletme girişi yapabilirler. Menü, rol ve modül
            yetkilerine göre otomatik filtrelenir.
          </p>
        </div>
      ...
      <div className="flex gap-3">
        <div className="relative flex-1 max-w-sm">
          ...
          <FormField
            label="Ad, e-posta veya telefon ara"
            hideLabel
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-gray-400 text-xs border-b border-gray-200">
              ...
              <th className="text-left py-2 pr-4">Telefon (giriş)</th>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="modal-card w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Personel /isletme adresinden cep telefonu veya e-posta ile giriş yapar. Telefon, giriş
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField
                  label={
                    PHONE_REQUIRED_ROLES.has(form.role)
                      ? 'Cep Telefonu (giriş) *'
                      : 'Cep Telefonu (giriş)'
                  }
                  className="input w-full"
            ...
            <div className="flex gap-3 mt-5">
              ...
              <button
                ...
                disabled={
                  saving ||
                  !form.name ||
                  (PHONE_REQUIRED_ROLES.has(form.role) && !form.phone.trim()) ||
